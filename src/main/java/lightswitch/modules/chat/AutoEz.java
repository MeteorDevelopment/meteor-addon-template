...
public class AutoEz extends Module {
    ...
    public AutoEz() {
        super(Lightswitch.CATEGORY, "auto-ez", "Send a chat message after killing a player.");
    }
    ...
    private void send() {
        ...
        if (msgplayers.size() == 0) return;
            ...
            if (checkPm()) {
                mc.player.sendChatMessage("/msg " + String.join(", ", msgplayers + " " + message));
            } else if (!checkPm()){
